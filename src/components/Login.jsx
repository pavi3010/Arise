...
function Login() {
  ...
  // Only show Google login if no offline user
  const hasOfflineUser = !!localStorage.getItem('ariseUser');
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        ...
        {!hasOfflineUser && (
          <button 
            ...
            disabled={loading}
            className="flex items-center justify-center w-full px-4 py-2 space-x-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
          >
